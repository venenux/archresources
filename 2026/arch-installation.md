...
installation on multiple devices over the years. **It uses GRUB! not shistemd-boot.**
...
```
doas pacman -Syu doas lesspipe perl xdg-utils xz ncurses \
 cabextract gawk tar 7zip unace unarj unrar unzip zip doas bash coreutils nano \
...
```
pacman -Syu  iw wpa_supplicant os-prober grub ntfs-3g \
 psmisc ncurses procps-ng net-tools rkhunter unhide alsa-utils \
 lshw acpi htop tree socat lsof unhide psmisc
 libgudev udisks2 bluez bluez-utils blueman arandr
